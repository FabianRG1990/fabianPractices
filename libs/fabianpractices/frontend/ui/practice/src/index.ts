/*
 * Public API Surface of practice
 */
...
export * from './inputOutputSinDecorador/HijoInput/hijoInput.component';

export * from './inputOutputSinDecorador/HijoOutput/hijoOutput.component';

export * from './inputOutputSinDecorador/PadreOutput/padreOutput.component';
